...
Theory
------
:class:`~oop_ml.numpy.classification.binary.logistic_regression.LogisticRegression`
walks
...
class NewtonLogisticRegression(IterativeSolver, LinearClassifier):
    ...
    :class:`~oop_ml.numpy.classification.binary.logistic_regression.LogisticRegression`
    and reaches it in single-digit iterations rather than hundreds of epochs,
    ...
    def _sigmoid(linear_predictor: FloatArray) -> Probabilities:
        ...
        Delegates to :func:`~oop_ml.numpy.classification.logistic.sigmoid`, shared
