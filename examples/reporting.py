...
reason :class:`~oop_ml.core.evaluation.RegressionEvaluation` is: the logger is state the
formatting needs, and passing it to every call would be a parameter every caller
has to remember.
"""
